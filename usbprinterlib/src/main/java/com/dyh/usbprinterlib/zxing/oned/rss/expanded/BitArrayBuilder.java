...
final class BitArrayBuilder {
  ...
  static BitArray buildBitArray(List<com.dyh.usbprinterlib.zxing.oned.rss.expanded.ExpandedPair> pairs) {
    ...
    com.dyh.usbprinterlib.zxing.oned.rss.expanded.ExpandedPair firstPair = pairs.get(0);
    ...
    for(int i = 1; i < pairs.size(); ++i){
      com.dyh.usbprinterlib.zxing.oned.rss.expanded.ExpandedPair currentPair = pairs.get(i);
