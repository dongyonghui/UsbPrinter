...
final class DetectionResult {
  ...
  private final com.dyh.usbprinterlib.zxing.pdf417.decoder.BarcodeMetadata barcodeMetadata;
  private final DetectionResultColumn[] detectionResultColumns;
  private com.dyh.usbprinterlib.zxing.pdf417.decoder.BoundingBox boundingBox;
  private final int barcodeColumnCount;

  DetectionResult(com.dyh.usbprinterlib.zxing.pdf417.decoder.BarcodeMetadata barcodeMetadata, com.dyh.usbprinterlib.zxing.pdf417.decoder.BoundingBox boundingBox) {
  ...
  private int adjustRowNumbers() {
    ...
    for (int barcodeColumn = 1; barcodeColumn < barcodeColumnCount + 1; barcodeColumn++) {
      com.dyh.usbprinterlib.zxing.pdf417.decoder.Codeword[] codewords = detectionResultColumns[barcodeColumn].getCodewords();
  ...
  private void adjustRowNumbersFromBothRI() {
    ...
    com.dyh.usbprinterlib.zxing.pdf417.decoder.Codeword[] LRIcodewords = detectionResultColumns[0].getCodewords();
    com.dyh.usbprinterlib.zxing.pdf417.decoder.Codeword[] RRIcodewords = detectionResultColumns[barcodeColumnCount + 1].getCodewords();
    for (int codewordsRow = 0; codewordsRow < LRIcodewords.length; codewordsRow++) {
      if (LRIcodewords[codewordsRow] != null &&
        ...
        for (int barcodeColumn = 1; barcodeColumn <= barcodeColumnCount; barcodeColumn++) {
          com.dyh.usbprinterlib.zxing.pdf417.decoder.Codeword codeword = detectionResultColumns[barcodeColumn].getCodewords()[codewordsRow];
          if (codeword == null) {
            continue;
          }
  ...
  private int adjustRowNumbersFromRRI() {
    ...
    com.dyh.usbprinterlib.zxing.pdf417.decoder.Codeword[] codewords = detectionResultColumns[barcodeColumnCount + 1].getCodewords();
    for (int codewordsRow = 0; codewordsRow < codewords.length; codewordsRow++) {
      if (codewords[codewordsRow] == null) {
        continue;
      }
  ...
  private int adjustRowNumbersFromLRI() {
    ...
    int unadjustedCount = 0;
    com.dyh.usbprinterlib.zxing.pdf417.decoder.Codeword[] codewords = detectionResultColumns[0].getCodewords();
    for (int codewordsRow = 0; codewordsRow < codewords.length; codewordsRow++) {
      if (codewords[codewordsRow] == null) {
        continue;
      }
  ...
  private static int adjustRowNumberIfValid(int rowIndicatorRowNumber, int invalidRowCounts, com.dyh.usbprinterlib.zxing.pdf417.decoder.Codeword codeword) {
    if (codeword == null) {
  ...
  private void adjustRowNumbers(int barcodeColumn, int codewordsRow, com.dyh.usbprinterlib.zxing.pdf417.decoder.Codeword[] codewords) {
    com.dyh.usbprinterlib.zxing.pdf417.decoder.Codeword codeword = codewords[codewordsRow];
    com.dyh.usbprinterlib.zxing.pdf417.decoder.Codeword[] previousColumnCodewords = detectionResultColumns[barcodeColumn - 1].getCodewords();
    com.dyh.usbprinterlib.zxing.pdf417.decoder.Codeword[] nextColumnCodewords = previousColumnCodewords;
    if (detectionResultColumns[barcodeColumn + 1] != null) {
      nextColumnCodewords = detectionResultColumns[barcodeColumn + 1].getCodewords();
    }

    com.dyh.usbprinterlib.zxing.pdf417.decoder.Codeword[] otherCodewords = new com.dyh.usbprinterlib.zxing.pdf417.decoder.Codeword[14];
    ...
    for (com.dyh.usbprinterlib.zxing.pdf417.decoder.Codeword otherCodeword : otherCodewords) {
   ...
   */
  private static boolean adjustRowNumber(com.dyh.usbprinterlib.zxing.pdf417.decoder.Codeword codeword, com.dyh.usbprinterlib.zxing.pdf417.decoder.Codeword otherCodeword) {
  ...
  public void setBoundingBox(com.dyh.usbprinterlib.zxing.pdf417.decoder.BoundingBox boundingBox) {
    this.boundingBox = boundingBox;
  }

  com.dyh.usbprinterlib.zxing.pdf417.decoder.BoundingBox getBoundingBox() {
    return boundingBox;
  }
