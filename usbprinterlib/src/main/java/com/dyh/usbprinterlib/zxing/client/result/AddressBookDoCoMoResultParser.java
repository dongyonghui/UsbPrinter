 ...
 * @author Sean Owen
 */
public final class AddressBookDoCoMoResultParser extends com.dyh.usbprinterlib.zxing.client.result.AbstractDoCoMoResultParser {

  @Override
  public com.dyh.usbprinterlib.zxing.client.result.AddressBookParsedResult parse(Result result) {
