...
public final class Result {
  ...
  private final com.dyh.usbprinterlib.zxing.BarcodeFormat format;
  ...
  /**
   * @return {@link com.dyh.usbprinterlib.zxing.BarcodeFormat} representing the format of the barcode that was decoded
   */
