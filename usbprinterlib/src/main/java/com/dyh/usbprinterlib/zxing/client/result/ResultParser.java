...
package com.dyh.usbprinterlib.zxing.client.result;
...
public abstract class ResultParser {
   ...
   * of information (email, URL, etc.) and return a {@link com.dyh.usbprinterlib.zxing.client.result.ParsedResult} encapsulating
   * the result of parsing.
   *
   * @param theResult the raw {@link Result} to parse
   * @return {@link com.dyh.usbprinterlib.zxing.client.result.ParsedResult} encapsulating the parsing result
   */
  public abstract com.dyh.usbprinterlib.zxing.client.result.ParsedResult parse(Result theResult);
  ...
  public static com.dyh.usbprinterlib.zxing.client.result.ParsedResult parseResult(Result theResult) {
