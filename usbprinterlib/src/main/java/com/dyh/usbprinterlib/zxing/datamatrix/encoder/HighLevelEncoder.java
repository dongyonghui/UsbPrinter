...
package com.dyh.usbprinterlib.zxing.datamatrix.encoder;

import java.util.Arrays;

import com.dyh.usbprinterlib.zxing.Dimension;
...
public final class HighLevelEncoder {
  ...
  public static String encodeHighLevel(String msg) {
    return encodeHighLevel(msg, com.dyh.usbprinterlib.zxing.datamatrix.encoder.SymbolShapeHint.FORCE_NONE, null, null);
  }
  ...
  public static String encodeHighLevel(String msg,
    ...
    com.dyh.usbprinterlib.zxing.datamatrix.encoder.Encoder[] encoders = {
        new com.dyh.usbprinterlib.zxing.datamatrix.encoder.ASCIIEncoder(), new com.dyh.usbprinterlib.zxing.datamatrix.encoder.C40Encoder(), new com.dyh.usbprinterlib.zxing.datamatrix.encoder.TextEncoder(),
        new com.dyh.usbprinterlib.zxing.datamatrix.encoder.X12Encoder(), new com.dyh.usbprinterlib.zxing.datamatrix.encoder.EdifactEncoder(),  new com.dyh.usbprinterlib.zxing.datamatrix.encoder.Base256Encoder()
    };

    com.dyh.usbprinterlib.zxing.datamatrix.encoder.EncoderContext context = new com.dyh.usbprinterlib.zxing.datamatrix.encoder.EncoderContext(msg);
