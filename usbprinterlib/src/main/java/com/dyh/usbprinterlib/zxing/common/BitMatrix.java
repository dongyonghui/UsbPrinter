...
package com.dyh.usbprinterlib.zxing.common;
...
public final class BitMatrix implements Cloneable {
  ...
  public void xor(BitMatrix mask) {
    ...
    com.dyh.usbprinterlib.zxing.common.BitArray rowArray = new com.dyh.usbprinterlib.zxing.common.BitArray(width / 32 + 1);
   ...
   *         your own row
   */
  public com.dyh.usbprinterlib.zxing.common.BitArray getRow(int y, com.dyh.usbprinterlib.zxing.common.BitArray row) {
    if (row == null || row.getSize() < width) {
      row = new com.dyh.usbprinterlib.zxing.common.BitArray(width);
    } else {
      row.clear();
    }
    int offset = y * rowSize;
  ...
  /**
   * @param y row to set
   * @param row {@link com.dyh.usbprinterlib.zxing.common.BitArray} to copy from
   */
  public void setRow(int y, com.dyh.usbprinterlib.zxing.common.BitArray row) {
  ...
  public void rotate180() {
    ...
    com.dyh.usbprinterlib.zxing.common.BitArray topRow = new com.dyh.usbprinterlib.zxing.common.BitArray(width);
    com.dyh.usbprinterlib.zxing.common.BitArray bottomRow = new BitArray(width);
